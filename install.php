...
<html>
<head>
	<title><?php echo $L->get('Gris') ?></title>
	...
	<link rel="stylesheet" type="text/css" href="bl-kernel/admin/themes/gris/css/bludit.css?version=<?php echo time() ?>">
...
<div class="container">
	<div class="row justify-content-md-center pt-5">
		<div class="col-md-4 pt-5">
			<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('Gris') ?></h1>
			<?php
			$system = checkSystem();
			if (!empty($system)) {
